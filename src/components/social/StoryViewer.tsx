...
import { Eye, MoreVertical, User, X } from 'lucide-react-native';
                                ...
                                <View style={styles.mediaContainer} pointerEvents="none">
                                    {currentStory.contentType === 'video' ? (
                                        <Video
                                            ...
                                            shouldPlay={visible && !isPaused && !showViewers && !showOptions}
                                            isLooping={false}
                                        />
                                    ) : (
                                        <Image
                                    ...
                                    <View style={styles.header}>
                                        <View style={styles.userInfo}>
                                            {currentStory.avatarUrl ? (
                                                <Image source={{ uri: currentStory.avatarUrl }} style={styles.userAvatar} />
                                            ) : (
                            ...
                            <View style={styles.viewersModalContainer}>
                                ...
                                <SafeAreaView style={[styles.viewersContent, { backgroundColor: isDark ? 'rgba(15,15,15,0.95)' : 'rgba(255,255,255,0.95)' }]}>
                                    <View style={[styles.viewersHeader, { borderBottomColor: theme.border }]}>
                                        <Text style={[styles.viewersTitle, { color: theme.text, fontFamily: typography.bodyBold }]}>Görüntüleyenler</Text>
